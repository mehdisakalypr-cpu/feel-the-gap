  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#07090F]">
      ...
      <div className="flex-1 max-w-6xl mx-auto w-full px-4 py-8">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-white mb-1">Trade Gap Reports</h1>
          <p className="text-gray-400 text-sm">
            {countries.length > 0
              ? `${countries.length} countries analyzed — click any to generate a full opportunity report`
              : 'Loading market data…'}
          </p>
        </div>
        ...
        <div className="flex flex-wrap gap-3 mb-6">
          ...
          >
            ...
            <option value="imports">Sort: Total imports</option>
            <option value="balance">Sort: Trade deficit</option>
          </select>
        </div>
        ...
        {!loading && filtered.length === 0 && (
          <div className="text-center py-20">
            ...
            <div className="text-white font-semibold mb-1">No countries yet</div>
            <div className="text-gray-400 text-sm mb-4">Data is being loaded from global trade sources</div>
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-2 text-xs">
                  <div className="bg-white/5 rounded-lg px-2.5 py-2">
                    <div className="text-gray-500 mb-0.5">Imports</div>
                ...
                {c.opportunity_count > 0 && (
                  <div className="mt-2.5 flex items-center justify-between">
                    <span className="text-xs text-gray-500">{c.opportunity_count} opportunities identified</span>
