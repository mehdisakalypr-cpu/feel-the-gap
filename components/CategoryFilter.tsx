  ...
  return (
    <>
      ...
      <button
        ...
        className="shrink-0 flex items-center justify-center border-r border-[rgba(201,168,76,.1)] bg-[#0D1117] hover:bg-[#161B22] transition-colors"
        style={{ width: collapsed ? 44 : 0, overflow: 'hidden', transition: 'width 0.2s' }}
        title="Ouvrir les filtres"
      >
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#C9A84C" strokeWidth="2" strokeLinecap="round"><path d="M3 6h18M3 12h18M3 18h18"/></svg>
      </button>
    <aside
    ...
    >
      ...
      {/* Collapse button + Active filters badge */}
      <div className="flex items-center justify-between px-3 py-2 border-b border-[rgba(201,168,76,.1)]">
        <button
        ...
        {totalFilters > 0 ? (
          ...
          <span className="text-[10px] text-gray-600">Filtres</span>
        )}
      </div>
